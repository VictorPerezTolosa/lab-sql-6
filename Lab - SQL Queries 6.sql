...
LOAD DATA INFILE "C:\Users\victo\Desktop\IRONHACK\BOOTCAMP\DAY15\LAB\lab-sql-6\files_for_lab\films_2020.csv"
INTO TABLE films_2020
COLUMNS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;  -- I've tried different ways to import the data and none of them work. I will use the import wizard

select * from films_2020; -- checking after using the import wizard and everything is imported

-- Update information on rental_duration, rental_rate, and replacement_cost.
update films_2020 
set rental_duration = 3, rental_rate = 2.99, replacement_cost = 8.99;

select * from films_2020; -- checking the results
